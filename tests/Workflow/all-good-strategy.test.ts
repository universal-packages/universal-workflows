...
describe(Workflow, (): void => {
  it('generates and run several routines grouped based on a single descriptor', async (): Promise<void> => {
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test1 [0]', strategy: 'test1', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 2, routine: 'test1 [0]', strategy: 'test1', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 3, routine: 'test1 [0]', strategy: 'test1', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test1 [1]', strategy: 'test1', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 2, routine: 'test1 [1]', strategy: 'test1', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 3, routine: 'test1 [1]', strategy: 'test1', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test1 [2]', strategy: 'test1', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 2, routine: 'test1 [2]', strategy: 'test1', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 3, routine: 'test1 [2]', strategy: 'test1', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test1 [3]', strategy: 'test1', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test1 [3]', strategy: 'test1', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 2, routine: 'test1 [3]', strategy: 'test1', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 3, routine: 'test1 [3]', strategy: 'test1', strategyIndex: 3 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test1 [3]', strategy: 'test1', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test1 [4]', strategy: 'test1', strategyIndex: 4 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test1 [4]', strategy: 'test1', strategyIndex: 4 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 2, routine: 'test1 [4]', strategy: 'test1', strategyIndex: 4 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 3, routine: 'test1 [4]', strategy: 'test1', strategyIndex: 4 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test1 [4]', strategy: 'test1', strategyIndex: 4 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test1 [5]', strategy: 'test1', strategyIndex: 5 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test1 [5]', strategy: 'test1', strategyIndex: 5 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 2, routine: 'test1 [5]', strategy: 'test1', strategyIndex: 5 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 3, routine: 'test1 [5]', strategy: 'test1', strategyIndex: 5 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test1 [5]', strategy: 'test1', strategyIndex: 5 } }])
