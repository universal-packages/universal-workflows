...
describe(Workflow, (): void => {
  it('runs routines in parallel respecting dependencies', async (): Promise<void> => {
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test3' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test3' } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test4 [0]', strategy: 'test4', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test4 [0]', strategy: 'test4', strategyIndex: 0 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test4 [0]', strategy: 'test4', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test4 [1]', strategy: 'test4', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test4 [1]', strategy: 'test4', strategyIndex: 1 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test4 [1]', strategy: 'test4', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test4 [2]', strategy: 'test4', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test4 [2]', strategy: 'test4', strategyIndex: 2 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test4 [2]', strategy: 'test4', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test4 [3]', strategy: 'test4', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test4 [3]', strategy: 'test4', strategyIndex: 3 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test4 [3]', strategy: 'test4', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test5' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test5' } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test6 [0]', strategy: 'test6', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test6 [0]', strategy: 'test6', strategyIndex: 0 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test6 [0]', strategy: 'test6', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test6 [1]', strategy: 'test6', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test6 [1]', strategy: 'test6', strategyIndex: 1 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test6 [1]', strategy: 'test6', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test6 [2]', strategy: 'test6', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test6 [2]', strategy: 'test6', strategyIndex: 2 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test6 [2]', strategy: 'test6', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test6 [3]', strategy: 'test6', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test6 [3]', strategy: 'test6', strategyIndex: 3 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test6 [3]', strategy: 'test6', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test7' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test7' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'success', measurement }])
    expect(listener.mock.calls).toContainEqual([{ event: 'end', measurement, payload: { endedAt } }])
  })
})
