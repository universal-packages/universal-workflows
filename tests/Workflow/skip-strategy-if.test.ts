...
describe(Workflow, (): void => {
  ...
  it('stops all the strategy routines when one fails', async (): Promise<void> => {
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test3 [0]', strategy: 'test3', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test3 [0]', strategy: 'test3', strategyIndex: 0 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test3 [0]', strategy: 'test3', strategyIndex: 0 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test3 [1]', strategy: 'test3', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test3 [1]', strategy: 'test3', strategyIndex: 1 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test3 [1]', strategy: 'test3', strategyIndex: 1 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 0, routine: 'test3 [2]', strategy: 'test3', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test3 [2]', strategy: 'test3', strategyIndex: 2 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test3 [2]', strategy: 'test3', strategyIndex: 2 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test3 [3]', strategy: 'test3', strategyIndex: 3 } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement, payload: { index: 1, routine: 'test3 [3]', strategy: 'test3', strategyIndex: 3 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement, payload: { name: 'test3 [3]', strategy: 'test3', strategyIndex: 3 } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'success', measurement }])
    expect(listener.mock.calls).toContainEqual([{ event: 'end', measurement, payload: { endedAt } }])
