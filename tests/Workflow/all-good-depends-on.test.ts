...
describe(Workflow, (): void => {
  it('runs routines in parallel respecting dependencies', async (): Promise<void> => {
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement: expect.any(Measurement), payload: { index: 0, routine: 'test3' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement: expect.any(Measurement), payload: { name: 'test3' } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement: expect.any(Measurement), payload: { index: 0, routine: 'test5' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement: expect.any(Measurement), payload: { name: 'test5' } }])

    expect(listener.mock.calls).toContainEqual([{ event: 'step:running', payload: { index: 0, routine: 'test6' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:running', payload: { name: 'test6' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'step:output', payload: { index: 0, routine: 'test6', data: 'test6\n' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement: expect.any(Measurement), payload: { index: 0, routine: 'test6' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement: expect.any(Measurement), payload: { name: 'test6' } }])
    ...
    expect(listener.mock.calls).toContainEqual([{ event: 'step:success', measurement: expect.any(Measurement), payload: { index: 0, routine: 'test7' } }])
    expect(listener.mock.calls).toContainEqual([{ event: 'routine:success', measurement: expect.any(Measurement), payload: { name: 'test7' } }])
