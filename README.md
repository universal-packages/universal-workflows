...
subProcess.on('routine:running', (event) => console.log(event))
subProcess.on('routine:skipped', (event) => console.log(event))
subProcess.on('routine:success', (event) => console.log(event))
subProcess.on('routine:failure', (event) => console.log(event))
subProcess.on('routine:stopping', (event) => console.log(event))
subProcess.on('routine:stopped', (event) => console.log(event))
subProcess.on('routine:error', (event) => console.log(event))

subProcess.on('step:running', (event) => console.log(event))
subProcess.on('step:skipped', (event) => console.log(event))
subProcess.on('step:success', (event) => console.log(event))
subProcess.on('step:failure', (event) => console.log(event))
subProcess.on('step:stopping', (event) => console.log(event))
subProcess.on('step:stopped', (event) => console.log(event))
subProcess.on('step:error', (event) => console.log(event))
subProcess.on('step:output', (event) => console.log(event))
```
